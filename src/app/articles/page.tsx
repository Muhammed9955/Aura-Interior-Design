...
import { BookOpen, Clock, X, ArrowLeft, ArrowRight, Sparkles, CheckCircle2, User } from 'lucide-react';
  ...
  const articles = [
    ...
    },
    {
      ...
      contentAr: [
        ...
        'الاستعانة برخام الكوارتز أو الجرانيت الطبيعي في السطح الرئيسي (Countertop) يمنح المطبخ مقاومة عالية للخدش والزيوت.',
                ...
                <div>
                  <div className="relative aspect-[16/9] overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 flex items-center gap-2">
                      <span className="px-3 py-1 rounded-full text-[10px] font-semibold bg-[#C5A059] text-white uppercase tracking-wider">
                        {lang === 'ar' ? art.categoryAr : art.categoryEn}
                      </span>
                      <span className="px-3 py-1 rounded-full text-[10px] font-semibold bg-black/60 text-white backdrop-blur-md flex items-center gap-1">
